            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 gap-6">
                    <div className="text-center md:text-left">
                        <span className="font-script text-3xl text-secondary block mb-2">Editor's Choice</span>
                        <h2 className="font-serif text-5xl md:text-6xl text-primary font-bold">Featured Creations</h2>
                    </div>
                    <Link href="/gallery">
                                ...
                                <div className="p-2">
                                    <Card className="group border-none transition-all duration-700 bg-card overflow-hidden rounded-[2.5rem]">
                                        <CardContent className="p-0">
                                            ...
                                            <div className="p-8">
                                                <h3 className="font-serif text-3xl text-primary mb-3 font-bold line-clamp-1">{product.name}</h3>
